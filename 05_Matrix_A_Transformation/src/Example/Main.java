...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        vbo.Pointer(color_loc, 3, stride, 5 * Float.BYTES);
        ...
        while (dm.IsRunning())
        {
            ...
            transform.Translate(new Vector3f(1.0f, 0.0f, -1.0f));
            transform.Rotate(45.0f, new Vector3f(1.0f, 0.0f, -1.0f));
            shader_program.SetMatrix4("transform", transform.GetMat4());
